...
username = 'sangjun'
while True:
   img = cv2.imread('./data_img/1/{}0000{}.jpg'.format(username,i))
   ...
   outfilename = './processed__img/1/{}0000{}-1.jpg'.format(username,i)
   cv2.imwrite(outfilename, img0)
   outfilename = './processed__img/1/{}0000{}-2.jpg'.format(username,i)
   cv2.imwrite(outfilename, img1)
   outfilename = './processed__img/1/{}0000{}-3.jpg'.format(username,i)
   cv2.imwrite(outfilename, img2)
   outfilename = './processed__img/1/{}0000{}-4.jpg'.format(username,i)
